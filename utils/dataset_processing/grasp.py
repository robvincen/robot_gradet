...
def detect_grasps(q_img, ang_img, width_img=None, no_grasps=1):
    ...
    """
    local_max = peak_local_max(q_img, min_distance=20, threshold_abs=0.2, num_peaks=no_grasps)  #0.2
    ...
    for grasp_point_array in local_max:
        ...
        g = Grasp(tuple([90, 175]), grasp_angle)
        if width_img is not None:
            g.length = width_img[grasp_point] + 20
            g.width = g.length/2
